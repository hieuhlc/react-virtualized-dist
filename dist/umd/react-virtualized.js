   ...
   */
    ...
    var CellSizeAndPositionManager = function() {
        function CellSizeAndPositionManager(_ref) {
            var cellCount = _ref.cellCount, cellSize = _ref.cellSize, estimatedCellSize = _ref.estimatedCellSize;
            classCallCheck(this, CellSizeAndPositionManager), this._cellSizeAndPositionData = {}, 
            this._lastMeasuredIndex = -1, this._lastBatchedIndex = -1, this._cellCount = cellCount, 
            this._cellSize = cellSize, this._estimatedCellSize = estimatedCellSize;
        }
        return createClass(CellSizeAndPositionManager, [ {
            key: "_getSize",
            value: function(index) {
                return "function" == typeof this._cellSize ? this._cellSize({
                    index: index
                }) : this._cellSize;
            }
        }, {
            ...
            key: "configure",
            value: function(_ref2) {
                var cellCount = _ref2.cellCount, estimatedCellSize = _ref2.estimatedCellSize, cellSize = _ref2.cellSize;
                this._cellCount = cellCount, this._estimatedCellSize = estimatedCellSize, this._cellSize = cellSize;
            }
        }, {
            key: "getCellCount",
            value: function() {
            ...
            value: function(index) {
                if (this._validateIndex(index), "number" != typeof this._cellSize) throw Error("_calculateSizeAndPositionByHeight should only be called if CellSize is a number.\n         Current CellSize type is " + _typeof(this._cellSize) + ".");
                return {
            ...
            value: function(index) {
                if (this._validateIndex(index), index > this._lastMeasuredIndex) for (var lastMeasuredCellSizeAndPosition = this.getSizeAndPositionOfLastMeasuredCell(), _offset = lastMeasuredCellSizeAndPosition.offset + lastMeasuredCellSizeAndPosition.size, i = this._lastMeasuredIndex + 1; i <= index; i++) {
                    var _size = this._getSize(i);
            ...
            value: function(index) {
                return this._validateIndex(index), "number" == typeof this._cellSize ? this._arithmeticallyCalculateSizeAndPosition(index) : this._iterativelyCalculateSizeAndPosition(index);
            }
        }, {
            ...
            key: "getTotalSize",
            value: function() {
                if ("number" == typeof this._cellSize) return this._cellCount * this._cellSize;
            ...
            value: function(offset) {
                if ("number" != typeof this._cellSize) throw Error("_arithmeticallyCalculateNearesetCell should only be called if CellSize is a number.\n         Current CellSize type is " + _typeof(this._cellSize) + ".");
            ...
            value: function(offset) {
                ...
                if (offset = Math.max(0, offset), "number" == typeof this._cellSize) return this._arithmeticallyCalculateNearesetCell(offset);
